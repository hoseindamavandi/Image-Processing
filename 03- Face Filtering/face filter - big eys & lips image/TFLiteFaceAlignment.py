...
def zoom_efect(frame, landmarks):
...
if __name__ == '__main__':
    ...
    frame = cv2.imread('/Users/hossein/Documents/python/Image-Processing/03- Face Filtering/face filter - big eys & lips image/input/obama.jpg')
    ...
    frame = zoom_efect(frame, landmarks_lips)
    frame = zoom_efect(frame, landmarks_left_eye)
    frame = zoom_efect(frame, landmarks_right_eye)


    cv2.imwrite('out/resultfinall.jpg', frame)
